...
include 'exportX.php';
	...
	switch ($oper){
		...
		case "list":
			...
			$filtro999="(substr(prodotto,1,11) <> 'AZZERAMENTO')";
			if ($filtro>"") {
			...
			if ($sort>"")
				...
				$ordinamento="data_inizio desc , id_order asc ";
		...
		$npag=0;
			...
			$campiElenco="id_order as id,descrizione as descr";
